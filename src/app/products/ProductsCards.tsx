    ...
    <div className="flex-1 p-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 h-100">
        {productItems.map((product) => (
          <Link
            href={`/products/${categoryId}/${subcategoryId}/${product.id}`}
            key={product.id}
          >
            <Card className="overflow-hidden py-0 cursor-pointer border-none bg-transparent hover:bg-card hover:shadow-lg transition-shadow duration-300 h-[440px] flex flex-col">
